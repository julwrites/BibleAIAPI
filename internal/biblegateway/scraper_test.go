...
func TestGetVerse(t *testing.T) {
	testCases := []struct {
		...
		// 	expected: `<p><span><sup>5</sup>Trust in the Lord with all your heart,</span><br/><span>and do not lean on your own understanding.</span><br/><span><sup>6</sup>In all your ways acknowledge him,</span><br/><span>and he will make straight your paths.</span></p>`,
		// },
		// {
		// 	name:     "Psalm 121",
		// 	book:     "Psalm",
		...
		// 	expected: "<h3>My Help Comes from the Lord</h3><h4>A Song of Ascents.</h4><p><span><sup>1 </sup>I lift up my eyes to the hills.</span><br/><span><span>From where does my help come?</span><br/><span><sup>2 </sup>My help comes from the Lord,</span><br/><span><span>who made heaven and earth.</span></p><br/><p><span><sup>3 </sup>He will not let your foot be moved;</span><br/><span>he who keeps you will not slumber.</span><br/><span><sup>4 </sup>Behold, he who keeps Israel</span><br/><span>will neither slumber nor sleep.</span></p><br/><p><span><sup>5 </sup>The Lord is your keeper;</span><br/><span>the Lord is your shade on your right hand.</span><br/><span><sup>6 </sup>The sun shall not strike you by day,</span><br/><span>nor the moon by night.</span></p><br/><p><span><sup>7 </sup>The Lord will keep you from all evil;</span><br/><span>he will keep your life.</span><br/><span><sup>8 </sup>The Lord will keep</span><br/><span>your going out and your coming in</span><br/><span>from this time forth and forevermore.</span></p>",
		// },
		{

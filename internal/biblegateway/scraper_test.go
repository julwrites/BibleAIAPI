...
func TestGetVerse(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expected: "<p><span><sup>5 </sup> Trust in the Lord with all your heart,</span><span>and do not lean on your own understanding.</span><span><sup>6 </sup>In all your ways acknowledge him,</span><span>and he will make straight your paths.</span></p>",
		},
		{
			name:     "Psalm 121",
			book:     "Psalm",
